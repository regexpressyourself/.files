...
(setq mc/cmds-to-run-for-all
 '(
  ...
  (global-set-key (kbd "C-c f") 'bf-pretty-print-xml-region)


  (defun compile-java()
    (interactive)
    (shell-command "bash ~/scripts/java_compiler.sh" ))
  (global-set-key (kbd "C-c x") 'compile-java)
  ...
  (global-set-key (kbd "C-c ]") 'ggtags-find-definition)
