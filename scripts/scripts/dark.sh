...
rm /home/topsteptrader/dotfiles/vim/.config/nvim/colors.vim



ln -s /home/topsteptrader/dotfiles/vim/.config/nvim/darkcolors.vim /home/topsteptrader/dotfiles/vim/.config/nvim/colors.vim
